verdad = [
    ...
    "¿Qué es lo último que has grabado en el móvil?",
    "¿Cuál es la apuesta más ridícula que has hecho nunca?",
    "¿Preferirías volver al pasado o viajar al futuro?",
    "¿Alguna vez has visto a alguien robar y te has callado?",
    "¿Qué es lo más vergonzoso que has hecho?",
    "¿Te arrepientes de algún tatuaje?",
    ...
    "¿Qué te da más grima?",
    "¿Alguna vez te has defecado encima?",
    ...
    "¿Quieres más a tu madre o a tu padre?",
    ...
    "¿Cuál es el mejor lugar para hacerlo?",
    "¿Qué es algo que nunca harás en la cama?",
    "¿Alguna vez has reservado un hotel sólo para tener sexo?",
    "¿Alguna vez has ido a una playa nudista?",
    ...
    "¿Cuál es un juguete sexual que nunca usarías?",
    "¿Has ido a un sex-shop alguna vez?",
    "¿Alguna vez has dudado sobre tu sexualidad?",
    "¿Tendrías un lío con alguien de la política?",
    "¿Qué película odias por encima de todo?",
    "¿Y qué actor o actriz?",
    "¿Tienes algún 'hobbie' extraño?",
    ...
    "¿Te has hecho pasar por un famoso?",
    "¿Has intentado ligar con un famoso?",
    "¿Debes dinero a algún amigo?",
    "¿Te debe dinero alguien?",
    "¿Alguna vez has tenido que maquillarte un chupetón?",
    "¿Alguna vez has hecho un chupetón a alguien?",
    "¿Te gustaría ser otra persona?",
    "¿Alguna vez has enviado 'nudes'?",
    "¿Y has recibido 'nudes'?",
    "¿Te has equivocado mandándolas alguna vez?",
    "¿Cuál ha sido el mensaje más guarro que has recibido?",
    "¿Alguna vez has rechazado a alguien sólo por su físico?",
    "¿Cuál es el último mensaje que has mandado?",
    "¿Y que has recibido?",
    ...
    "¿Quién es la última persona que has seguido en Instagram?",
    "¿Cuándo fue la última vez que llamaste a tu madre y para qué?",
    "¿Alguna vez has tenido una ETS?",
    ...
    "¿Alguna vez han estado a punto de pillarte tocándote?",
    "¿Con quién pensaste la última vez que te masturbaste?",
    "¿Qué es lo más loco que haces cuando estás solo/a?",
    "¿Has practicado algo de bdsm?",
    "¿Alguna vez has tenido un orgasmo en sueños?",
    "¿Cuál es tu palabra grosera favorita?",
    "¿Cuál es tu técnica de seducción?",
    "¿Te operarías algo si pudieras?",
    "¿Duermes desnudo o en pijama?",
    "¿Cuándo ha sido la última vez que alguien te ha visto desnudx?",
    "¿A quién no te gustaría ver desnudo?",
    "¿Alguna vez has tenido una cita a ciegas?",
    "¿Harías un striptease a tu pareja?",
    "¿Beso seco, húmedo o mojado?",
    "De este grupo, ¿a quién besarías antes?",
    ...
    "¿Cuántos chupitos puedes beberte seguidos?",
    "Si el mundo se acabara y pudieras salvar solo a una persona para sobrevivir, ¿a quién salvarías?",
    "¿Has traicionado alguna vez un secreto por culpa del alcohol?",
    "¿Has vomitado alguna vez en una fiesta y luego has vuelto a beber?",
    "¿Cuántos años tenías la primera vez que te masturbaste?",
    "¿Has mentido alguna vez para caerle bien a alguien?",
    "¿Quién fue tu primer gran 'crush'?",
    "¿Alguna vez te han puesto una multa?",
    "¿Te han arrestado alguna vez?",
    "¿Has mentido a la policía alguna vez?",
    "¿Alguna vez te has tirado un pedo en un ascensor?",
    "Si pudieras hacer desaparecer un país, ¿cuál sería?",
