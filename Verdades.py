Verdades = [
    ...
    "¿Has tenido sexo en la calle o en un sitio público?",
    ...
    "¿Te acostarías con alguien de esta habitación por dinero?",
    ...
    "¿Tendrías relaciones sexuales con alguien de tu mismo sexo?", 
    "¿Qué categoría porno es tu favorita?",
    "Qué es lo que mejor haces en el sexo?", 
]
